...
<div class="row">
    <div class="mb-3 col-12">
        ...
        <input {{ $readonlyForm == 'readonly' ? 'disabled' : '' }} type="file" class="form-control file-img" id="cover_image"  accept="image/png, image/gif, image/jpeg" wire:model="form.cover_image_name" style="display: none">
    ...
    <div class="mb-3 col-md-4">
        <label for="isbn" class="form-label">ISBN</label>
         <input {{ $readonlyForm }} type="text" class="form-control @error('form.isbn') is-invalid @enderror" id="isbn" wire:model="form.isbn" >
        @error('form.isbn') <span class="text-danger">{{ $message }}</span> @enderror
    </div>
    <div class="mb-3 col-md-4">
        <label for="title" class="form-label">Title</label>
        <input {{ $readonlyForm }} type="text" class="form-control @error('form.title') is-invalid @enderror" id="title" wire:model="form.title">
        @error('form.title') <span class="text-danger">{{ $message }}</span> @enderror
    </div>
    <div class="mb-3 col-md-4">
        <label for="author" class="form-label">Author</label>
        <input {{ $readonlyForm }} type="text" class="form-control @error('form.author') is-invalid @enderror" id="author" wire:model="form.author">
        @error('form.author') <span class="text-danger">{{ $message }}</span> @enderror
    </div>
    <div class="mb-3 col-md-6">
        <label for="published_year" class="form-label">Published Year</label>
        <input {{ $readonlyForm }} type="number" class="form-control @error('form.published_year') is-invalid @enderror" id="published_year" wire:model="form.published_year">
    ...
    <div class="mb-3 col-md-6">
        ...
        <input {{ $readonlyForm }} type="number" step="0.01" class="form-control @error('form.price_per_book') is-invalid @enderror" id="price_per_book" wire:model="form.price_per_book">
        @error('form.price_per_book') <span class="text-danger">{{ $message }}</span> @enderror
    </div>
    <div class="mb-3 col-md-6">
        <label for="quantity" class="form-label">Quantity</label>
        <input {{ $readonlyForm }} type="number" class="form-control @error('form.quantity') is-invalid @enderror" id="quantity" wire:model="form.quantity">
    ...
    <div class="mb-3 col-md-6">
        ...
        <input {{ $readonlyForm }} type="number" class="form-control @error('form.quantity_now') is-invalid @enderror" id="quantity_now" wire:model="form.quantity_now">
    ...
    <div class="mb-3 col-md-6">
        ...
        <div class="d-flex align-items-center  gap-4">
            ...
            <button type="button" class="btn bg-white shadow-sm rounded-3" data-bs-toggle="modal" data-bs-target="#categoryModal" style="white-space: nowrap;display:{{ $readonlyForm == 'readonly' ? 'none' : 'block' }}">
                Select Categories
            </button>
        </div>
    ...
    <div class="mb-3 col-md-6">
        ...
        <div class="d-flex align-items-center  gap-4">
            ...
            <button type="button" class="btn bg-white shadow-sm rounded-3" data-bs-toggle="modal" data-bs-target="#bookshelfModal" style="white-space: nowrap;display:{{ $readonlyForm == 'readonly' ? 'none' : 'block' }}">
                Select Bookshelves
            </button>
        </div>
    ...
    <div class="mb-3 col-12">
        ...
        <textarea {{ $readonlyForm }} class="form-control @error('form.description') is-invalid @enderror" id="description" rows="5" wire:model="form.description"></textarea>
    ...
    <div class="d-flex justify-content-end gap-3 px-5">
        ...
        @if ((isset($isEditPage) && $isEditPage) && Auth::user()->can('delete', $form->book))
            <button type="button" class="btn btn-danger shadow-sm" data-bs-toggle="modal" data-bs-target="#deleteModal">
                <span class="me-1"><i class="bi bi-trash"></i></span>
                <span>Delete</span>
            </button> 
        @endif
        @if (Auth::user()->can('update', $form->book) || Auth::user()->can('create', App\Models\Book::class))
